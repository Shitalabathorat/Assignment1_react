          ...
          <>
            <div className="header-container">
                <img src="https://assets.ccbp.in/frontend/react-js/history-website-logo-img.png"
                 ...
                 <div className="input-container">
                     ...
                     <input type="search" className="searchInput" placeholder="Search History"
            ...
            <div className="app-container">
                <ul className="history-container">
                    {searchResults.length===0?(<p className="error">There is no history to show</p>) : (
...
export default class BrowserHistory extends Component {
  ...
  getSearchResults = e => {
    ...
    const filteredItems = initialHistoryList.filter(each =>
      each.title.toLowerCase().includes(searchTearm.toLowerCase()),
    )
    this.setState({historyItem: filteredItems})
